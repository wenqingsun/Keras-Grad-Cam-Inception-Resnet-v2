...
def train_model():
    ...
    adagrad = optimizers.Adagrad(lr=learning_rate, epsilon=None, decay=decay)
    ...
    history_dir = os.path.join(save_dir, experiment_name, model_name + '_history_1.jpg')
...
model_name = 'trained_model_inception-resnetv2_tl_two_stage_1.h5'
